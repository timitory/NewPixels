                ...
                <form @submit.prevent="validateForm" class="flex flex-col justify-center items-center space-y-7">
                    ...
                    <div class="flex flex-row justify-center items-center space-x-6">
                        <div class="mt-4 lg:mt-6">
                            ...
                            <input type="text" placeholder="Enter Fi" v-model="user.firstname" class="mt-2 w-full bg-white py-2 px-3 rounded outline-none border border-slate focus:outline-none focus:ring-1 focus:ring-violet focus:border-transparent focus:border-0" required>
