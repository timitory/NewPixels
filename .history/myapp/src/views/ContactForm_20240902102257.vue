                ...
                <form @submit.prevent="validateForm" class="flex flex-col justify-center items-center space-y-7">
                    ...
                    <div class="flex flex-row justify-center items-center space-x-6">
                        <div class="mt-4 lg:mt-6">
                            ...
                            <p v-if="error.first" class="text-danger text-sm mt-2">Please enter a valid Email Address</p>
                          </div>
                          <div class="mt-4 lg:mt-6">
                    ...
                    <div class="flex flex-row justify-center items-center space-x-6">
                        <div class="mt-4">
                          ...
                          <div class="mt-4">
                              ...
                              <p v-if="error.phone" class="text-danger text-sm mt-2">Please enter a valid Email Address</p>
                            </div>
                    </div>
                    <div class="w-full">
                        <div class="mt-4">
