    ...
    <div class="flex">
        <div class="flex justify-center items-center">
            <div class="flex flex-row justify-center items-center py-28 px-80">
                <form @submit.prevent="validateForm" class="flex flex-col justify-center items-center space-y-11">
                    ...
                    <div class="flex flex-row justify-center items-center space-x-11">
