    ...
    <div class="w-full px-96 py-11">
        <div class="flex flex-col w-full  shadow-lg rounded-lg bg-white p-8">
             ...
             <form @submit.prevent="validateForm" class="w-full">
               ...
               <h1></h1> <router-link to="/signup" class="inline-block mt-6 text-center rounded focus:outline-none bg-gray-100 text-charcoal py-2 w-full text-white">Create a new account in 2mins</router-link>
                <div class="mt-4">
