                    ...
                    <div class="flex flex-row justify-center items-center space-x-6">
                        <div class="mt-4 lg:mt-6">
                          ...
                          <div class="mt-4 lg:mt-6">
                              ...
                              <input type="email" placeholder="Enter Email Address" v-model="user.last" class="mt-2 w-full bg-white py-2 px-3 rounded outline-none border border-slate focus:outline-none focus:ring-1 focus:ring-violet focus:border-transparent focus:border-0" required>
                              <p v-if="error.email" class="text-danger text-sm mt-2">Please enter a valid Email Address</p>
                            </div>
                    </div>
                    <div class="flex flex-row justify-center items-center space-x-6">
