             ...
             <form @submit.prevent="validateForm" class="w-full">
                <div class="w-full">
                    ...
                    <div class="mt-2 bg-white w-full rounded relative">
                        <input type="password" v-model="user.password" ref="password" class="w-full py-2 px-3 rounded outline-none border border-slate focus:outline-none focus:ring-1 focus:ring-army focus:border-transparent focus:border-0" required>
                    ...
                    <input type="password" v-model="confirm" ref="confirm" class="mt-2 w-full py-2 px-3 rounded outline-none border border-slate focus:outline-none focus:ring-1 focus:ring-army focus:border-transparent focus:border-0" required>
