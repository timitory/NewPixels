...
import Signup2 from '../Signup.vue';
export default{
    name:'SIGNUP',
    components:{
        Signup,Signup2
  ...
  methods:{
    ...
    register(){
        const {company_name,  email, phone, password,} = this.user
        this.$store.dispatch('registerUser', {company_name, email, phone, password,})
        .then((res)=>{
