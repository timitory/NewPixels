        ...
        <div class="flex flex-col w-full  shadow-lg rounded-lg bg-white p-8">
             ...
             <form @submit.prevent="showNext" class="w-full">
                ...
                <div class="mt-4 lg:mt-6">
                    ...
                    <input type="text" placeholder="Enter Phone Number" v-model.nu="user.phone" class="mt-2 w-full bg-white py-2 px-3 rounded outline-none border border-gray-200 focus:outline-none focus:ring-1 focus:ring-violet focus:border-transparent" required>
