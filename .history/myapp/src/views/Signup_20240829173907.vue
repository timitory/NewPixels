        ...
        <div class="flex flex-col w-full  shadow-lg rounded-lg bg-white p-8">
             ...
             <form @submit.prevent="validateForm" class="w-full">
                ...
                <div class="mt-4 lg:mt-6">
                    ...
                    <input type="text" placeholder="Enter Comapny Name" v-model="user.company_name" class="mt-2 w-full bg-white py-2 px-3 rounded outline-none border border-gray-200 focus:outline-none focus:ring-1 focus:ring-violet focus:border-transparent focus:border-0" required>
                ...
                <div class="mt-4 lg:mt-6">
                  ...
                  <input type="email" placeholder="Enter Email Address" v-model="user.email" class="mt-2 w-full bg-white py-2 px-3 rounded outline-none border border-gray-200 focus:outline-none focus:ring-1 focus:ring-violet focus:border-transparent focus:border-0" required>
                ...
                <div class="mt-4 lg:mt-6">
                    ...
                    <input type="text" v-model="user.phone" class="mt-2 w-full bg-white py-2 px-3 rounded outline-none border border-gray-200 focus:outline-none focus:ring-1 focus:ring-violet focus:border-transparent" required>
                ...
                <p v-if="error.password" class="text-red-500 text-sm mt-2">Please enter a valid phone number</p>
                ...
                <div class="flex justify-between items-center">
                    <div class="flex space-x-3 text-balance text-dark">
                        ...
                        <h1>By signing up, I agree with the Terms of Service and Privacy Policy</h1>
