    ...
    <div class="w-full px-96 py-11">
        <div class="flex flex-col w-full  shadow-lg rounded-lg bg-white p-8">
             ...
             <form @submit.prevent="validateForm" class="w-full">
               ...
               <h1 class="inline-block mt-6 text-center rounded focus:outline-none text-sm py-2 w-full text-dark">Don't have an account? <router-link to="/signup" class="">Sign Up</router-link></h1> 
                <div class="mt-4">
