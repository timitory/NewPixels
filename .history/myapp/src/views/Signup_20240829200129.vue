             ...
             <form @submit.prevent="showNext" class="w-full">
                ...
                <div class="mt-4 lg:mt-6">
                  ...
                  <div class="mt-2 bg-white w-full rounded relative">
                    <input type="password" placeholder="Enter Password" v-model="user.address" ref="password" class="mt-2 w-full bg-white py-2 px-3 rounded outline-none border border-gray-200 focus:outline-none focus:ring-1 focus:ring-violet focus:border-transparent" required>
