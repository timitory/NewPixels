            ...
            <div class="flex flex-row justify-center items-center py-28 px-80">
                <form @submit.prevent="validateForm" class="flex flex-col justify-center items-center space-y-7">
                    ...
                    <div class="flex justify-between w-full space-x-6">
                        <div class="flex flex-col space-x-3 space-y-2 text-balance justify-center items-center text-dark">
                        ...
                        <div class="flex flex-col justify-center space-y-2 items-center space-x-3 text-balance text-dark">
                            <div class="flex space-x-3">
                                <input type="checkbox"  v-model="user.checkbox" ref="checkbox" class="p-3 w-11" required>
                                <label class="text-dark font-semibold">Last Name *</label>
                            </div>
                        ...
                        <div class="flex flex-col space-x-3  space-y-2 text-balance justify-start items-center text-dark">
                            <div class="flex space-x-3">
                                <input type="checkbox"  v-model="user.checkbox" ref="checkbox" class="p-3" required>
                                <label class="text-dark font-semibold">Last Name *</label>
                            </div>
