    ...
    <div class="w-full px-96 py-11">
        <div class="flex flex-col w-full shadow-lg rounded-lg bg-white py-9">
             <div class="flex flex-col text-center justify-start text-balance">
                  <p class="text-2xl font-bold text-dark text-center">Password Reset Link</p>
               ...
               <g>
                  ...
                  <p class="text-sm font-bold text-violet text-center px-3 pt-7">A link was sent to the email you provided. Click on the <span class="text-dark"> <router-link to="/newpassword">link </router-link></span>to create  new password.</p>
