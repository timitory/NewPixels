    ...
    <div class="w-full px-96 py-11">
        <div class="flex flex-col w-full  shadow-lg rounded-lg bg-white p-8">
             ...
             <form @submit.prevent="showNext" class="w-full">
               ...
               <h1 class="inline-block mt-6 text-center rounded focus:outline-none text-sm py-2 w-full text-dark"><router-link to="/signup" class="text-violet">Go Back</router-link></h1> 
              </form>
        </div>
     </div>
   </template>
