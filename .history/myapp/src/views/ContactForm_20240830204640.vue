                    ...
                    <!-- <p class="text-red-500 mt-4">{{errorMsg}}</p> -->
                     <div class="">
                        ...
                        <div class="flex flex-col">
                            <p><label for="message">would love to give us a brief on what you want?</label></p>
                            <textarea name="message" id="message" cols="30" rows="10" class="flex w-full " placeholder="Your message"></textarea>
                        </div>
                     </div>
