                    ...
                    <div class="flex flex-row justify-center items-center space-x-6">
                        <div class="mt-4">
                          ...
                          <div class="mt-4">
                              ...
                              <input type="number" placeholder="09022474543" v-model="user.phone" class="mt-2 w-full bg-white py-2 px-3 rounded outline-none border border-slate focus:outline-none focus:ring-1 focus:ring-violet focus:border-transparent focus:border-0" required>
                              <p v-if="error.email" class="text-danger text-sm mt-2">Please enter a valid Email Address</p>
                            </div>
                    </div>
                    <div class="w-full">
                        <div class="mt-4">
                            ...
                            <input type="text" placeholder="Enter Email Address" v-model="user.email" class="mt-2 w-full bg-white py-2 px-3 rounded outline-none border border-slate focus:outline-none focus:ring-1 focus:ring-violet focus:border-transparent focus:border-0" required>
                            <p v-if="error.email" class="text-danger text-sm mt-2">Please enter a valid Email Address</p>
                          </div>
                    </div>
